export default function FilterIndicator({ hasFilter, filterLabel, message = "Todos os gráficos estão filtrados." }) {
  ...
  return (
    <div className="bg-green-50 border border-green-200 rounded-lg px-4 py-2.5 mb-4 text-sm text-green-700 flex items-center gap-2 transition-all duration-200" data-i18n-translate>
